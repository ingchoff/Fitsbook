...
import 'package:fitsbook/NewFeed/map_screen.dart';
...
class Comment extends StatefulWidget {
  ...
  final double lat;
  final double long;
  Comment({this.title, this.no, this.userPic, this.userId, this.lat, this.long});
                    ...
                    Container(
                      ...
                      Column(
                        ...
                        children: <Widget>[
                              ...
                              new RaisedButton(
                                child: new Text('ดูตำแหน่งที่โพสต์',
                                style: new TextStyle(
                                        fontSize: userSize,
                                        color: Colors.white,
                                        fontWeight: FontWeight.bold                   
                                ...
                                color: Colors.green,
                                onPressed: (){
                                  Navigator.push(context, MaterialPageRoute(builder: (context) => MapScreen(map_lat: widget.lat, map_long: widget.long)));
                                },
                              ),
                            ],
                          ),
